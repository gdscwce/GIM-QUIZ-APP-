...
import 'WelcomeD.dart';

class Team4Login extends StatefulWidget {
  const Team4Login({Key? key}) : super(key: key);

  @override
  State<Team4Login> createState() => _Team4LoginState();
}
String pass ="";
TextEditingController KthisName=TextEditingController();
TextEditingController KthisPassword= TextEditingController();
late String Kname;
class _Team4LoginState extends State<Team4Login> {
